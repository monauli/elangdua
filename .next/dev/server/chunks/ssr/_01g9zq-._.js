...
;
const metadata = {
    title: 'Elang Dua — Cita Rasa Legendaris',
    description: 'Company profile dan product showcase Elang Dua.',
    keywords: [
        'Elang Dua',
        'kecap',
        'Singkawang'
    ...
    openGraph: {
        title: 'Elang Dua — Cita Rasa Legendaris',
        description: 'Rasa pilihan yang menemani dapur Indonesia sejak 1965.',
        images: [
            '/og-image.svg'
        ]
    },
